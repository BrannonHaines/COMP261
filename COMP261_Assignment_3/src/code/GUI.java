...
public abstract class GUI {
	...
	private void initialise() {
		...
		JButton findAPts = new JButton("Find Articulation Points");
		findAPts.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
		...
		JButton findMST = new JButton("Find Minimum Spanning Tree");
		findMST.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				if (!Graph.nodes.isEmpty()) {
				Mapper.findMSTKruskal();
				redraw();
				}
			}
		});
		...
		loadquit.add(load);
		loadquit.add(findAPts);
		loadquit.add(findMST);
		loadquit.add(quit);
